...
export const OutboxIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
export const UsersIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962c.51.056 1.02.082 1.5.082a21.21 21.21 0 017.5 0c.51.056 1.02.082 1.5.082m-7.5-2.962a3.375 3.375 0 00-3-3.375m0 0c-.552 0-1 .448-1 1s.448 1 1 1m3-3.375c.621 0 1.125.504 1.125 1.125s-.504 1.125-1.125 1.125m0-1.125a3.375 3.375 0 013 3.375m0 0c.552 0 1-.448 1-1s-.448-1-1-1m-3 3.375a3.375 3.375 0 00-3-3.375m0 0c-.552 0-1 .448-1 1s.448 1 1 1m-6.75-1.125a3.375 3.375 0 00-3-3.375m0 0c-.552 0-1 .448-1 1s.448 1 1 1m3-3.375c.621 0 1.125.504 1.125 1.125s-.504 1.125-1.125 1.125m0-1.125a3.375 3.375 0 013 3.375m-3.375 0c-.552 0-1 .448-1 1s.448 1 1 1" />
    </svg>
);
...
export const PrinterIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.72 13.829c-.24.03-.48.062-.72.096m.72-.096a42.415 42.415 0 0110.56 0m-10.56 0L6 3.369m0 0a6.75 6.75 0 0112 0m0 0v10.46A42.415 42.415 0 0112 14.25c-2.305 0-4.502.322-6.624.912m14.348 4.114a9.026 9.026 0 01-3.41 1.62m-13.478 0a9.026 9.026 0 013.41-1.62m10.068 0a9.026 9.026 0 00-3.41-1.62" />
    </svg>
);
...
export const ArchiveBoxArrowDownIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3v11.25A2.25 2.25 0 006 16.5h12A2.25 2.25 0 0020.25 14.25V3M3.75 3v-1.5A2.25 2.25 0 016 0h12a2.25 2.25 0 012.25 2.25v1.5M3.75 3h16.5M12 16.5v6.75m-3-3l3 3 3-3" />
  </svg>
);
...
export const DocumentChartBarIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3v11.25A2.25 2.25 0 0 0 6 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0 1 18 16.5h-2.25m-7.5 0h7.5m-7.5 0-1 3m8.5-3l1 3m0 0l.5 1.5m-.5-1.5h-9.5m0 0l-.5 1.5M9 11.25v1.5M12 9v3.75m3-6v6" />
    </svg>
);

export const GripVerticalIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 5.25v.01M12 12v.01M12 18.75v.01M16.5 5.25v.01M16.5 12v.01M16.5 18.75v.01M7.5 5.25v.01M7.5 12v.01M7.5 18.75v.01" />
  </svg>
);
...
export const GlobeAltIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 008.716-6.747M12 21a9.004 9.004 0 01-8.716-6.747M12 21c.34 0 .672-.015.993-.045M12 21v-5.625M3.284 14.255a9.004 9.004 0 001.077 3.51M20.716 14.255a9.004 9.004 0 01-1.077 3.51m-16.36 0c.205.378.43.74.67 1.085m14.34 0c.24-.345.465-.707.67-1.085M12 3a9 9 0 100 18 9 9 0 000-18zm-5.625 5.25a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z" />
  </svg>
);

export const CalendarIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0h18M12 12.75h.008v.008H12v-.008zm0 4.5h.008v.008H12v-.008zm-4.5-4.5h.008v.008H7.5v-.008zm4.5 0h.008v.008H12v-.008zm-4.5 4.5h.008v.008H7.5v-.008zm-4.5-4.5H3.75v.008H3v-.008zm0 4.5H3.75v.008H3v-.008zm12-4.5h.008v.008H15v-.008zm4.5 0h.008v.008H19.5v-.008zm0 4.5h.008v.008H19.5v-.008z" />
  </svg>
);

export const ChatBubbleLeftRightIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.72 3.72a1.125 1.125 0 0 1-1.59 0l-3.72-3.72A1.125 1.125 0 0 1 9 15.118V10.61A1.125 1.125 0 0 1 10.125 9.5h5.418a1.125 1.125 0 0 0 .972-.544l1.073-1.952a1.125 1.125 0 0 1 .458-.495m-8.432 8.432L3.75 14.25a1.125 1.125 0 0 1 0-1.59l3.72-3.72a1.125 1.125 0 0 1 1.59 0l3.72 3.72a1.125 1.125 0 0 1 0 1.59l-3.72 3.72a1.125 1.125 0 0 1-1.59 0Z" />
  </svg>
);
